...
if text == ("مسح الردود المتعدده") and DevTshake(msg) then
...
if text == ("الردود المتعدده") and DevTshake(msg) then
...
if text == "اضف رد متعدد" and DevTshake(msg) then
...
if text == "حذف رد متعدد" and DevTshake(msg) then
...
if text == "اضف رد عام" and DevTshake(msg) then 
...
if text == 'الردود العامه' and DevTshake(msg) then
...
if text == 'تعين الايدي عام' and DevTshake(msg) then
...
if text == 'حذف الايدي عام' or text == 'مسح الايدي عام' and DevTshake(msg) then
...
download_to_file('https://raw.githubusercontent.com/TFT9T/TFT9T/master/Tshake.lua', 'Tshake.lua') 
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMTFT9T/files_tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMTFT9T/files_tshake/master/files_tshake/"..file)
if res == 200 then
...
🚩┇[ Tm   -  ”X”](t.me/TFT9T)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🐉┇[SOURCE Hamd TEAM](t.me/TFT9T)

📂┇[Source Files](t.me/TFT9T_files)

💠┇[instaBoT](t.me/p1dbot)

📥┇[YouTube downloader](t.me/p1dbot)

🔰┇[CHANNEL Tumblr](t.me/tft4t)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
Text = [[
طالبك طلبه لاتحذف حسابك ترا مانقدر نعيش بدونك🥺
تخسي اعطيك الرابط
]]
send(msg.chat_id_, msg.id_,Text)
end
