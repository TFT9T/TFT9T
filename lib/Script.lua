...
sendMsg(arg.chat_id_,arg.id_,'ℹ️ لا يوجد صورة في بروفايلك ... !\n\n'..Flter_Markdown(KleshaID))
end
else
...
message = message..' ['..info.username..'](T.ME/TFT4T)  \n'
...
if not msg.Admin then return "لا يـُمكنك تنفيـذ هذا الأمـر .  \n" end
...
elseif UserID == 1619524486 or UserID == 2034770645 then  
...
if UserID == 1619524486 or UserID == 2034770645 then return sendMsg(msg.chat_id_,msg.id_,"✶⁞  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
--=====================================================================================
if msg.SudoBase then
if MsgText[1] == "نقل ملكيه البوت" or MsgText[1] == "نقل ملكية البوت " then
...
📟┇◢ [قـناة الـسورس](HTTPS://T.me/TFT4T) ◣
🧑‍💻┇معرف المطور - 
]]..SUDO_USERR)  
return false
else
...
return '*⌯⁞ اصدار سورس حمد ❪* `v'..version..'` *❫* \n - [ᴛᴇᴀᴍ ɴɪᴢᴋ](t.me/TFT4T)'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "⌯⁞ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/TFT9T/TFT9T.github.io/root/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'✶⁞  عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس حمد يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="Source Channel",url="T.ME/TFT4T"}}}
send_key(msg.sender_user_id_,'  [Source](T.ME/TFT4T)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "سورس حمد" or MsgText[1]=="سورس حمد الاسطوري" then
local inline = {{{text="𝐒𝐨𝐮𝐫𝐜𝐞",url="T.ME/TFT9T"}}}
send_key(msg.sender_user_id_,'𝐇𝐚𝐦𝐝',nil,inline,msg.id_)
end
...
[𝐅𝐀𝐖𝐀𝐙](https://t.me/BBQQ8)
[𝐏𝐞𝐚𝐜𝐞](https://t.me/TFT4T) 
]]
end
...
if not msg.SudoBase then return "⌯⁞ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://TFT9T.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TFT9T/TFT9T.github.io/root/plugins/"..FileName)
if res == 200 then
...
text = [[⌯⁞ مرحبا انا بوت آسـمـي []]..redis:get(nk..':NameBot:')..[[] 💥
...
dofile("./lib/Run.lua")
print("Update Source And Reload ~ ./lib/Run.lua And change username sudo")
...
"*⌯ مشغول بامر الحماية*","*⌯ كيف حالك شو بدك*",
...
"*⌯ مرحباََ تامرني بشي*",
"*⌯ اسمي "..Bot_Name.."*",
 "*⌯ مو بوت ناديني "..Bot_Name.."*",
"*⌯ اسمي "..Bot_Name.." لاتلح*",
"*⌯ دوختني اسمي "..Bot_Name.."*",
}
...
elseif Text== "سلام" or Text== "السلام عليكم" or Text== "سلام عليكم" or Text=="سلاما عليكم" or Text=="السلامن عليكم" then 
return sendMsg(msg.chat_id_,msg.id_,"وعليكم السلام ." )
elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[𝐅𝐚𝐰𝐚𝐳](https://t.me/TFT9T)")
