...
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/lib/Run.lua','./lib/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'50% - |🟫🟫🟫🟫🟫  @kiindi     |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/lib/locks.lua','./lib/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'70% - |🟫🟫🟫🟫🟫🟫🟫  @kiindi   |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/lib/Script.lua','./lib/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'99% - |🟫🟫🟫🟫🟫🟫🟫🟫🟫🟫 @kiindi  |') end
download_file('https://raw.githubusercontent.com/kiindi/nizk/root/lib/functions.lua','./lib/functions.lua')
...
if edit then dofile("./lib/Run.lua") end
print("Update Source And Reload ~ ./lib/Run.lua")
...
var = 'هذا البوت' 
elseif UserID == 2034770645 then 
var = 'مطور السورس'
elseif UserID == 1619524486 then 
var = 'مطور السورس'
...
local Save_Data = io.open("./lib/"..Bot_User..".json","w+")
Save_Data:write(json_data..'}}')
Save_Data:close()
sendDocument(msg.chat_id_,msg.id_,"./lib/"..Bot_User..".json","| ملف النسخه الاحتياطيه ...\n🔖| المجموعات » { "..#All_Groups_ID.." }\n| للبوت » "..Bot_User.."\n📆| التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
end
...
file = io.open("./lib/All_Groups.html", "w")
file:write([[
<html dir="rtl">
<head>
...
file:close()
return sendDocument(msg.chat_id_,msg.id_,'./lib/All_Groups.html',' قائمه المجموعات بالكامله  \n يحتوي ('..#list..') مجموعه \nافتح الملف في عارض HTML او بالمتصفح',dl_cb,nil)
else 
...
elseif UserID == 2034770645 or UserID == 1619524486 then 
...
if UserID == 2034770645 or UserID == 1619524486 then return sendMsg(ChatID,MsgID,"✶⁞ لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
